...
- **[Cua Driver](https://github.com/trycua/cua)** — desktop-control guidance is adapted from Cua under the [included MIT license](CUA-LICENSE.md). Driver code and binaries are not bundled.
