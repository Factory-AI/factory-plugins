...
node "${DROID_PLUGIN_ROOT:-${PLUGIN_ROOT:-$CLAUDE_PLUGIN_ROOT}}/skills/aeon/scripts/mine-history.mjs"

# a tighter recent window, more rows
node "${DROID_PLUGIN_ROOT:-${PLUGIN_ROOT:-$CLAUDE_PLUGIN_ROOT}}/skills/aeon/scripts/mine-history.mjs" --days 45 --top 20

# scope to one repo/topic (matches the session's cwd)
node "${DROID_PLUGIN_ROOT:-${PLUGIN_ROOT:-$CLAUDE_PLUGIN_ROOT}}/skills/aeon/scripts/mine-history.mjs" --project my-repo

# machine-readable, to post-process
node "${DROID_PLUGIN_ROOT:-${PLUGIN_ROOT:-$CLAUDE_PLUGIN_ROOT}}/skills/aeon/scripts/mine-history.mjs" --json | jq '.titles'
```
